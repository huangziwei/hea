...
def test_pirls_one_iter_matches_lme4_RglmerWrkIter():
    ...
    lp0_r = np.array(
        [
            ...
            0.17568734650690293,
            0.1682690284513515,
            0.098214827004023647,
            0.12280510740918449,
            0.16804642189181557,
            -0.040337595793121225,
            -0.011217047237106759,
            -0.028852712113060897,
            -0.0042488794387191831,
            -0.010545284074168146,
            0.18333872776234761,
            0.1594219123976012,
            0.097221012108133109,
            0.15874182576234713,
            0.10002159718441234,
            -0.053086615484341029,
            0.027958747905701034,
            -0.055053559106356578,
            0.0082220805235372896,
            -0.039534948054757005,
            -0.37455441934327727,
            -0.40413546753393786,
            -0.45079993775051996,
            -0.40046791695021278,
    ...
    delu_r = np.array(
        [
            ...
            0.36990671024423449,
            0.19375187648539827,
            0.000272881029242308,
            0.19383628180949175,
            0.00082717010020249497,
            -0.4473243967846941,
        ]
    )
...
def test_pirls_u_only_keeps_beta_at_zero():
    ...
    y = rng.poisson(
        np.exp(0.5 + 0.3 * x + 0.4 * rng.standard_normal(n_groups)[g])
    ).astype(float)
...
_GLMER_DEVFUN_POISSON_REF = {
    ...
    "beta": np.array(
        [
            0.2903914913216376625,
            0.2509776419271669834,
        ]
    ),
...
def test_devfun_stage0_matches_lme4_poisson():
    ...
    assert dev_hea == pytest.approx(
        _GLMER_DEVFUN_POISSON_REF["dev_stage0"],
        rel=1e-9,
        abs=1e-9,
    )
...
def test_devfun_stage1_matches_lme4_poisson():
    ...
    assert dev_hea == pytest.approx(
        _GLMER_DEVFUN_POISSON_REF["dev_stage1"],
        rel=1e-9,
        abs=1e-9,
    )
...
def test_glmer_binomial_full_fit_matches_lme4_cbpp():
    ...
    beta_r = np.array(
        [
            -1.3983428639994452957751,
            -0.9919249753929506585592,
            -1.1282162163483180350454,
            -1.5797454141259090754090,
        ]
    )
...
def test_glmer_start_validation_errors():
    ...
    with pytest.raises(ValueError, match="start theta has shape"):
        gmm(
            ...
            df,
            family=PoissonFamily(),
            start={"theta": np.array([1.0, 2.0])},
        )  # too many
    with pytest.raises(ValueError, match="start beta has shape"):
        gmm(
            "y ~ x + (1|g)", df, family=PoissonFamily(), start={"beta": np.array([1.0])}
        )  # wrong p
...
_GLMER_PHASE6_POISSON_REF = {
    ...
    "eta": np.array(
        [
            1.410618575763747495,
            1.008984116283886179,
            1.314908011603527438,
            1.258692307627020224,
            1.112650719170245051,
            0.6484802656970650725,
            0.4268356621102136206,
            0.3553131917271484252,
            0.6398406977133539453,
            0.4924301284176147986,
            0.5088883079114701058,
            0.4280186499596442262,
            0.3320296517719327767,
            0.3309303885178981885,
            -0.2516050122900676533,
            0.7256725472931924159,
            0.5423099502373873726,
            0.4422090719232229516,
            -1.19285035831270303,
            -0.817772904069066886,
            -1.073373250908278065,
            -1.032215317690151846,
            -1.340252049583974925,
            -0.6229946817996792063,
            1.576265365936122986,
            2.043052916300658772,
            1.998594910635623556,
            1.578759840006084936,
            1.726129475194391638,
            1.997260828757384754,
            -1.703794076292931781,
            3.735448612639821864,
            0.2879074333503188754,
            -0.458770401584667753,
            -0.4177845561549925479,
            -0.2798655799599198968,
            -0.3564436617485257641,
            -0.2971881514635524857,
            0.5798059757310553008,
            -1.99730541297464903,
            1.675019624910016436,
            -0.583758094277295303,
            2.23132906528325714,
            1.355694820037147696,
            -1.742324165038875439,
            -0.2683569636895323796,
            -0.2899823596485366917,
            -0.2645241447005106106,
            -0.25845911922611714,
            -0.1799230304580301809,
            -0.2596605796078225725,
            0.2370158165364349978,
            -0.6008524870213434177,
            2.06815303550074292,
            -1.244111333953813681,
            -1.365616713760832379,
            0.7996796638019258996,
        ]
    ),
    ...
    "se_beta": np.array(
        [
            0.3240398280839200673,
            0.1067890110072432786,
        ]
    ),
    "t_value": np.array(
        [
            0.8961598734289905055,
            2.350219742274265222,
        ]
    ),
    "vcov": np.array(
        [
            0.1050018101846564716,
            3.378233554156873537e-05,
            3.378233554156873537e-05,
            0.01140389287190512503,
        ]
    ).reshape(2, 2),
    "sd_re_g": np.array(
        [
    ...
    "ranef_g": np.array(
        [
            0.9895708665079689936,
            0.3209495804845613476,
            0.09721379600562723988,
            -1.281275415166094778,
            1.273775043561228282,
            0.6592637890781458676,
            0.217243020009267096,
            0.3483427836059935778,
            -1.270218944503318959,
            0.9691542015173817415,
            -1.570322741609319284,
            -0.1091674116882686563,
        ]
    ),
}
...
def test_glmer_phase6_attrs_match_lme4_poisson():
    ...
    np.testing.assert_allclose(
        m.residuals_of("pearson"), r["res_pearson"], atol=1e-7, rtol=1e-7
    )
    np.testing.assert_allclose(
        m.residuals_of("working"), r["res_working"], atol=1e-7, rtol=1e-7
    )
    np.testing.assert_allclose(
...
def test_glmer_phase6_ranef_match_lme4_poisson():
    ...
    np.testing.assert_allclose(
        blups_py,
        _GLMER_PHASE6_POISSON_REF["ranef_g"],
        atol=1e-9,
        rtol=1e-7,
    )
...
def test_glmer_phase6_attrs_match_lme4_binomial_cbpp():
    ...
    se_beta_r = np.array(
        [
            ...
            0.3031507189593240503278,
            0.3228302907742182648043,
            0.4220492126057727166888,
        ]
    )
...
_GLMER_PREDICT_POISSON_REF = {
    ...
    "fit_newdata": np.array(
        [
            2.798223400284284956,
            2.58481846813017091,
            1.540645865305753981,
            3.172352850996323248,
            2.930415146927733527,
            1.198683749816668032,
        ]
    ),
    "fit_no_re": np.array(
        [
            1.52355696444375166,
            1.01960291224287225,
            1.384497343793165136,
            1.308814075241625519,
            1.130974728684837061,
            0.7109944886110036721,
            1.111695226779797485,
            1.03496086172365942,
            1.375601537444076428,
            1.187061051716656879,
            1.206759571820205323,
            1.113011126918823201,
            1.26467586452162184,
            1.26328641663990382,
            0.7055209532333136524,
            1.874718943314101161,
            1.560640250782709737,
            1.411983249326680179,
            1.092452377723830637,
            1.589631949439612724,
            1.231092718786930051,
            1.282819124944775124,
            0.9427287963068671228,
            1.931468768365345978,
            1.353224580357631046,
            0.6886909911984917532,
            0.6182361520591636017,
            0.4736531570845207151,
            0.4473756366841243337,
            0.5952441911713443057,
            0.5034171735920006663,
            0.5118545962728325849,
            0.4741388143137083011,
            0.4494222126318014876,
            0.4490146126314731312,
            0.3378685770984262704,
            0.7120466348521080624,
            0.5564259880533786173,
            0.497638684570495704,
            0.1743726503480499124,
            0.2515105758865468499,
            0.1942435132259601738,
            0.2019771642219961028,
            0.1542259790464217684,
            0.3138576840788409039,
            0.9683664340712575536,
            1.395683453841265687,
            1.276292824727641939,
            0.9676786857496911809,
            0.9540658777239680033,
            1.273034388448805787,
            0.5768506027869364505,
            0.6494725555168608944,
            0.5982612378593433755,
            0.6774361295519044646,
            0.6519576387451900823,
            0.9038064944180618232,
            0.6028971606265641769,
            0.4270234107287606551,
            0.5997686716909937932,
            0.4313618575189892557,
            0.4118353178920082791,
            0.6408877937011118187,
            0.4488862502477867222,
            0.5782546905057768249,
            0.4665518164632190268,
            0.8439861633390796092,
            0.6521000654299515809,
            0.4960531330286978013,
            0.2630563240480818243,
            0.2376689394848166825,
            0.1628559727971052862,
            0.2023819478537558503,
            0.1713772805372896502,
            0.2391217423284673904,
            0.6892461631997580662,
            0.773593028833852614,
            0.6227823088294430764,
            0.6471948584075091215,
            0.8821406543568881542,
            0.6432119716192330472,
            0.1732467242775596328,
            0.187538525986524679,
            0.1707669601851088681,
            0.166875826483454448,
            0.1200097889184357086,
            0.1676434518473451929,
            0.3108431672766777676,
            0.5977503559886035989,
            0.3468664594300374659,
            0.4405269530533396649,
            0.4881917092048277396,
            0.4249118984742671912,
        ]
    ),
...
def test_glmer_predict_link_and_response_match_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p_link["fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["fit_link"],
        atol=1e-7,
        rtol=1e-7,
    )
    np.testing.assert_allclose(
        p_resp["fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["fit_response"],
        atol=1e-7,
        rtol=1e-7,
    )
...
def test_glmer_predict_newdata_matches_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p["fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["fit_newdata"],
        atol=1e-7,
        rtol=1e-7,
    )
...
def test_glmer_predict_re_form_false_matches_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p["fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["fit_no_re"],
        atol=1e-7,
        rtol=1e-7,
    )
...
def test_glmer_predict_allow_new_levels_matches_lme4():
    ...
    new_rows = [1, 2]
    np.testing.assert_allclose(
        p["fit"].to_numpy()[new_rows],
        np.exp(eta_pop[new_rows]),
        atol=1e-12,
        rtol=1e-12,
    )
...
def test_glmer_predict_se_fit_link_matches_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p["se.fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["se_link_se"],
        atol=1e-7,
        rtol=1e-6,
    )
...
def test_glmer_predict_se_fit_response_matches_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p["se.fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["se_resp_se"],
        atol=1e-7,
        rtol=1e-6,
    )
...
def test_glmer_predict_random_only_matches_lme4_poisson():
    ...
    np.testing.assert_allclose(
        p["fit"].to_numpy(),
        _GLMER_PREDICT_POISSON_REF["fit_random_only"],
        atol=1e-7,
        rtol=1e-7,
    )
...
def test_deriv12_rosenbrock_matches_lme4():
    ...
    expected_hess = np.array(
        [
            [4.3000000199675560e02, -2.8000000000000000e02],
            [-2.8000000000000000e02, 2.0000000001490116e02],
        ]
    )
    np.testing.assert_allclose(g_py, expected_grad, atol=1e-10, rtol=1e-10)
    np.testing.assert_allclose(H_py, expected_hess, atol=1e-10, rtol=1e-10)
...
def test_deriv12_bound_shrinks_step_matches_lme4():
    ...
    expected_hess = np.array(
        [
            [2.5000002000011012e07, 3.8888888888889924e03],
            [3.8888888888889924e03, 1.9999999962747097e00],
        ]
    )
    np.testing.assert_allclose(g_py, expected_grad, atol=1e-10, rtol=1e-10)
    np.testing.assert_allclose(H_py, expected_hess, atol=1e-10, rtol=1e-10)
...
def test_family_validation_accepts_instance():
    ...
    from hea.family import LogLink, Poisson
...
def test_family_validation_rejects_quasi_string_with_lme4_message():
    ...
    for name in ("quasi", "quasibinomial", "quasipoisson"):
        with pytest.raises(
            ValueError, match='"quasi" families cannot be used in glmer'
        ):
...
def test_gh_rule_spot_checks_high_order():
    ...
    np.testing.assert_allclose(
        r10[0],
        (-4.85946282833231, 4.31065263071828e-06, -12.7261280231764),
        rtol=1e-9,
        atol=1e-12,
    )
    np.testing.assert_allclose(
        r10[4, :2], (-0.484935707515498, 0.344642334932019), rtol=1e-9
    )
    ...
    np.testing.assert_allclose(
        r25[0],
        (-8.71759767839959, 1.5300389979987e-17, -38.9171931744236),
        rtol=1e-9,
        atol=1e-20,
    )
...
_CBPP_AGQ_REF = {
    1: {
        ...
        "beta": [-1.398342863999, -0.991924975393, -1.128216216348, -1.579745414126],
        "dev": 73.474283618704,
        "lap": 184.053132779086,
    },
    5: {
        "theta": 0.647369199521,
        "beta": [-1.399201882121, -0.991438021208, -1.127859471008, -1.579506387556],
        "dev": 73.375824032273,
        "lap": 100.011367851843,
    },
    25: {
        "theta": 0.647519912197,
        "beta": [-1.399223727356, -0.991408884230, -1.127809594563, -1.579480951182],
        "dev": 73.373002519661,
        "lap": 100.010030540190,
    },
}
...
def test_glmer_cbpp_agq_matches_lme4(cbpp_frame, k):
    ...
    np.testing.assert_allclose(m.deviance_laplace, ref["lap"], atol=1e-6, rtol=1e-7)
...
def test_gmm_prefit_single_level_grouping_factor_raises():
    ...
    df = pl.DataFrame(
        {"y": np.arange(20.0) % 4, "x": np.linspace(0, 1, 20), "g": ["A"] * 20}
    )
...
def test_gmm_prefit_level_check_downgrade_to_ignore():
    ...
    try:
        gmm(
            ...
            df,
            family=Poisson(),
            control={"check.nlev.gtr.1": "ignore", "check.nobs.vs.nlev": "ignore"},
        )
...
def test_gmm_autoscale_matches_unscaled_fit():
    ...
    with warnings.catch_warnings():
        ...
        m1 = gmm("y ~ x + (1|g)", df, family=Poisson(), control={"autoscale": True})
...
_NB_REF = {
    "nb_theta": 1.8720849154,
    "cov_theta": 0.8048198320,
    "beta": [0.7458609323, 0.8719223520],
    "m2logL": 1248.88099643,
    "AIC": 1256.88099643,
    "npar": 4,
}
...
def test_gmm_free_theta_nb_delegates_to_glmer_nb():
    ...
    from hea.models.gmm import glmer_nb, gmm
...
def test_boot_ci_conversions_match_boot_package():
    ...
    t0 = 3.5
    np.testing.assert_allclose(
        _boot_ci_one(t0, t, 0.95, "perc"),
        [1.91562019410927, 5.15293511924754],
        atol=1e-10,
    )
    np.testing.assert_allclose(
        _boot_ci_one(t0, t, 0.95, "basic"),
        [1.84706488075246, 5.08437980589073],
        atol=1e-10,
    )
    np.testing.assert_allclose(
        _boot_ci_one(t0, t, 0.95, "norm"),
        [1.99893156024296, 5.12905716082019],
        atol=1e-10,
    )
...
def test_bootMer_sleepstudy_fixef_ci_matches_lme4():
    ...
    np.testing.assert_allclose(
        ...
        [243.552942479216, 260.474381762565],
        atol=1e-4,
    )
    np.testing.assert_allclose(
        ci.filter(pl.col("parameter") == "Days").row(0)[1:],
        [7.41510477042856, 11.92888251008135],
        atol=1e-4,
    )
...
def test_confint_profile_matches_lme4_dyestuff():
    ...
    np.testing.assert_allclose(
        ci.filter(pl.col("parameter") == ".sigma").row(0)[1:],
        [38.2299848826, 67.6576962448],
        atol=1e-2,
    )
    np.testing.assert_allclose(
        ci.filter(pl.col("parameter") == "(Intercept)").row(0)[1:],
        [1486.4514999688, 1568.5484943681],
        atol=1e-2,
    )
...
def test_confint_profile_glmm_unknown_scale_raises():
    ...
    df = pl.DataFrame({"y": y, "x": rng.normal(size=48), "g": [f"g{i}" for i in g]})
    m = gmm("y ~ x + (1|g)", df, family=Gamma(link="log"))
    with pytest.raises(NotImplementedError, match="non-fixed scale parameters"):
        m.profile()
    with pytest.raises(NotImplementedError, match="non-fixed scale parameters"):
...
def test_confint_profile_glmm_scale_known_matches_lme4_cbpp():
    ...
    np.testing.assert_allclose(row(".sig01"), [0.3460704968, 1.0998887415], atol=2e-3)
    np.testing.assert_allclose(
        row("(Intercept)"), [-1.9011888852, -0.9477681542], atol=2e-3
    )
    np.testing.assert_allclose(
        row("period2"), [-1.6168537016, -0.4077095870], atol=2e-3
    )
    np.testing.assert_allclose(
        row("period4"), [-2.5008377491, -0.8006870282], atol=2e-3
    )
...
def test_glmer_salamander_crossed_re_binomial_matches_lme4():
    ...
    np.testing.assert_allclose(
        m._beta,
        [1.0082303061708, -0.7020656417882, -2.9043009109890, -0.0178654949691],
        atol=2e-3,
    )
    np.testing.assert_allclose(
        m._se_beta, [0.3937554830, 0.4614657936, 0.5607604607, 0.5431333131], atol=2e-3
    )
...
def test_lmer_sleepstudy_uncorrelated_bars_matches_lme4():
    ...
    np.testing.assert_allclose(m.theta, [0.97989652794932, 0.23423122533467], atol=1e-7)
...
def test_check_boundary_pins_near_zero_when_improving():
    ...
    out = _check_boundary(
        devfun, np.array([1e-7]), devfun(np.array([1e-7])), lower, upper, 1e-5
    )
...
def test_gmm_devfunonly_glmer_stage1_handle():
    ...
    from hea.family import Poisson
    from hea.models.gmm import _DevFunHandle, gmm
    ...
    np.testing.assert_allclose(h.devfun(par), m.deviance_laplace, atol=1e-9, rtol=1e-9)
...
def test_gmm_devfunonly_glmer_nagq0_theta_only():
    ...
    np.testing.assert_allclose(
        h.devfun(m.theta), m.deviance_laplace, atol=1e-9, rtol=1e-9
    )
...
def test_glmer_control_optimizer_chain():
    ...
    assert _normalize_glmer_control({"optimizer": "Nelder_Mead"})["optimizer"] == [
        "Nelder_Mead",
        "Nelder_Mead",
    ]
...
def test_glmer_optimizer_dispatch_per_stage():
    ...
    for chain in (
        ...
        m = gmm("y ~ x + (1|g)", df, family=Poisson(), control={"optimizer": chain})
...
def test_glmer_control_optCtrl_routes_per_optimizer():
    ...
    from hea.models.gmm import (
        _bobyqa_kwargs_from_opt_ctrl,
        _nm_kwargs_from_opt_ctrl,
    )
...
def test_glmer_optCtrl_bobyqa_tuning_runs_end_to_end():
    ...
    m = gmm(
        ...
        df,
        family=Poisson(),
        control={"optimizer": ["bobyqa", "bobyqa"], "optCtrl": {"rhoend": 1e-9}},
    )
...
def test_gmm_subset_negative_int_indices_drop():
    ...
    m_pre = gmm("y ~ x + (1|g)", df.tail(df.height - 5), family=Poisson())
    np.testing.assert_allclose(m_arg.theta, m_pre.theta, atol=1e-12, rtol=1e-12)
...
def _three_level_glmm_df(seed: int = 2026):
    ...
    n_groups, n_per = 8, 10
    g = np.repeat(np.arange(n_groups), n_per)
    x = np.tile(np.array(["a", "b", "c"]), n_groups * n_per // 3 + 1)[
        : n_groups * n_per
    ]
...
def test_gmm_contrasts_arg_switches_to_contr_sum():
    ...
    m_sum = gmm("y ~ x + (1|g)", df, family=Poisson(), contrasts={"x": "contr.sum"})
...
def test_gmm_contrasts_arg_helmert():
    ...
    df = _three_level_glmm_df()
    m = gmm("y ~ x + (1|g)", df, family=Poisson(), contrasts={"x": "contr.helmert"})
...
def test_gmm_contrasts_arg_rejects_unknown_name():
    ...
    with pytest.raises(ValueError, match=r"contrasts\['x'\]"):
        gmm("y ~ x + (1|g)", df, family=Poisson(), contrasts={"x": "contr.bogus"})
...
def test_gmm_contrasts_arg_rejects_non_string_value():
    ...
    with pytest.raises(ValueError, match=r"only string names"):
        gmm("y ~ x + (1|g)", df, family=Poisson(), contrasts={"x": np.eye(3)})
...
def test_gmm_checkconv_gradient_diagnostic(capsys):
    ...
    under = gmm(
        ...
        family=Poisson(),
        control={
            "optimizer": ["Nelder_Mead", "Nelder_Mead"],
            "optCtrl": {"XtolRel": 5e-2, "FtolAbs": 5e-2, "maxfun": 40},
        },
    )
    ...
    ignored = gmm(
        ...
        control={
            "optimizer": ["Nelder_Mead", "Nelder_Mead"],
            "optCtrl": {"XtolRel": 5e-2, "FtolAbs": 5e-2, "maxfun": 40},
            "check.conv.grad": {"action": "ignore", "tol": 2e-3, "relTol": None},
        },
    )
    assert not any(
        "max|grad|" in m for m in ignored.optinfo["conv"]["lme4"]["messages"]
    )
...
def test_glmer_bates_fm10_contraception_matches_lme4():
    ...
    expected_se_for_beta = np.array(
        [
            ...
            3.2936286686357942876668,
            2.6142087304558478955130,
            0.1208624239243845793768,
            0.1632291674042204154826,
            0.1864493856133159488397,
            0.1875238509232133865545,
        ]
    )
    np.testing.assert_allclose(m.theta, expected_theta, atol=1e-5, rtol=1e-5)
    beta_se_rel = (
        np.abs(m.bhat.to_numpy().ravel() - expected_beta) / expected_se_for_beta
    )
    ...
    expected_qs = np.array(
        [
            -1.8437896503140969173273,
            -0.7591760654724690748907,
            -0.4639986075136982579536,
            0.9493036503091371036689,
...
_CM_REF = {
    "cm1": {
        ...
        "AIC": 2388.7287068547207,
        "BIC": 2433.2674722628267,
        "logLik": -1186.3643534273604,
        "dev_laplace": 2372.7287068547207,
        "dev_resid": 2289.7306592727905,
        "npar": 8,
        "df_resid": 1926,
        "pearson_q": [
            -1.8438164551717313,
    ...
    "cm2": {
        ...
        "AIC": 2385.1858190738521,
        "BIC": 2418.5898931299316,
        "logLik": -1186.5929095369261,
        "dev_laplace": 2373.1858190738521,
        "dev_resid": 2290.3956618293355,
        "npar": 6,
        "df_resid": 1928,
        "pearson_q": [
            -1.8150497388800013,
    ...
    "cm3": {
        "formula": ("use ~ age_s + I(age_s^2) + urban + ch + age_s:ch + (1|district)"),
        "colnames": [
            "(Intercept)",
            "age_s",
            "I(age_s^2)",
        ...
        "AIC": 2379.1813079332615,
        "BIC": 2418.1527276653542,
        "logLik": -1182.5906539666307,
        "dev_laplace": 2365.1813079332615,
        "dev_resid": 2282.9246322145832,
        "npar": 7,
        "df_resid": 1927,
        "pearson_q": [
            -1.8720410335459285,
    ...
    "cm4": {
        "formula": (
            "use ~ age_s + I(age_s^2) + urban + ch + age_s:ch + (1+urban|district)"
        ),
        "colnames": [
            "(Intercept)",
            "age_s",
        ...
        "theta": [0.61496553579326108, -0.57509470937327523, 0.44190385654424946],
        "beta": [
            -1.3441349102161679,
            -0.8324500403806161,
            -1.8362230871367438,
        ...
        "AIC": 2371.5304045633152,
        "BIC": 2421.6365156474344,
        "logLik": -1176.7652022816576,
        "dev_laplace": 2353.5304045633152,
        "dev_resid": 2235.2914451677857,
        "npar": 9,
        "df_resid": 1925,
        "pearson_q": [
            -1.9336610694581922,
...
def _parse_drop1(out):
    ...
    hi = next(i for i, ln in enumerate(lines) if "npar" in ln and "AIC" in ln)
    rows = {}
