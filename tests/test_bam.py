...
4. **summary()/rank parity**: pins the summary.gam tables and ``m.rank``
   on Gaussian, Poisson, and a rank-deficient fit. Neither is exercised by
   the predict/oracle sections above.
...
def test_bam_id_by_factor_matches_mgcv():
    ...
    (smooth.r:3947-3991), matching mgcv. Deriving it per masked level instead
    puts the sparsest level's edf ~70% high."""
